...
public enum DisputeExplanationCodeType {
    ...
    /**
     * 
     * 						This value is no longer applicable and should not be used in an <b>AddDispute</b> call, as it only pertains to <i>Significantly Not As Described</i> disputes initiated through PayPal, and those disputes are no longer supported by the <b>AddDispute</b>.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This value indicates that the buyer no longer wants the item (buyer remorse), and the seller is willing to cancel the order line item. This value is allowed when the <b>DisputeReason</b> value is <b>TransactionMutuallyCanceled</b>.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This value indicates that the buyer made a mistake by purchasing the item, and the seller is willing to cancel the order line item. This value is allowed when the <b>DisputeReason</b> value is <b>TransactionMutuallyCanceled</b>.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This value cannot be used in <b>AddDispute</b>, but it may be returned in the <b>GetDispute</b> or <b>GetUserDisputes</b> calls if the dispute explanation is unknown or was not specified.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This value will be returned in <b>GetDispute</b> or <b>GetUserDisputes</b> calls if the Unpaid Item case was opened by eBay through the Unpaid Item Assistance mechanism. This value cannot be used in <b>AddDispute</b>.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						 This value indicates that the seller ran out of stock on the item, cannot fulfill the order, and has to cancel the order line item. This value is allowed when the <b>DisputeReason</b> value is <b>TransactionMutuallyCanceled</b>.
     * 				    
     * 
     */
