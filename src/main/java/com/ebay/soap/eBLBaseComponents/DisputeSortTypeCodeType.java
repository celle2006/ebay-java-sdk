...
public enum DisputeSortTypeCodeType {
    ...
    /**
     * 
     * 						This is the default value. If this value is used in the <b>DisputeSortType</b> field, or if the <b>DisputeSortType</b> field is omitted from the <b>GetUserDisputes</b> request, retrieved Unpaid Item cases are sorted according to dispute creation time, in descending order.
     * 					
     * 
     */
    @XmlEnumValue("None")
    ...
    /**
     * 
     * 						If this value is used in the <b>DisputeSortType</b> field,  retrieved Unpaid Item cases are sorted according to creation time, in ascending order.
     * 					
     * 
     */
    ...
    /**
     * 
     * 					If this value is used in the <b>DisputeSortType</b> field,  retrieved Unpaid Item cases are sorted according to creation time, in descending order.
     * 					
     * 
     */
    ...
    /**
     * 
     * 					If this value is used in the <b>DisputeSortType</b> field,  retrieved Unpaid Item cases are sorted according to status, in ascending order.
     * 					
     * 
     */
    ...
    /**
     * 
     * 					If this value is used in the <b>DisputeSortType</b> field,  retrieved Unpaid Item cases are sorted according to status, in descending order.
     * 					
     * 
     */
    ...
    /**
     * 
     * 					If this value is used in the <b>DisputeSortType</b> field,  retrieved Unpaid Item cases are sorted according to whether the Unpaid Item cases are eligible for a Final Value Fee credit to the seller, in descending order. In other words, Unpaid Item cases eligible for a FVF credit are listed before Unpaid Item cases that are not eligible for a FVF credit.
     * 					
     * 
     */
