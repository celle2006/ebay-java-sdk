...
public enum RequiredSellerActionCodeType {
    ...
    /**
     * 
     * 						This value should no longer get returned as eBay buyers no longer have the option of creating Item not Received (INR) or Significantly not as Described (SNAD) disputes through PayPal's system.
     * 					
     * 
     */
