...
public enum DisputeResolutionReasonCodeType {
    ...
    /**
     * 
     * 						This enumeration value indicates that the Unpaid Item case has yet to be resolved.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This enumeration value indicates that the buyer had not paid due to a technical problem with a computer.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This enumeration value indicates that the buyer had not paid due to a family emergency.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This enumeration value indicates that the Unpaid Item case was the buyer's first infraction, and thus resolved.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This enumeration value indicates that the buyer and seller came to an agreement regarding payment or mutual cancellation of the order.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This enumeration value indicates that the seller received payment for the item, and thus the Unpaid Item case was closed.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This enumeration value is no longer applicable since it is related to an INR or SNAD dispute, which are no longer supported.
     * 					
     * 
     */
