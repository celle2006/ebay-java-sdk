 ...
 *     &lt;enumeration value="DepositProcessingVariableFee"/>
 *     &lt;enumeration value="DepositProcessingVariableFeeCredit"/>
...
public enum AccountDetailEntryCodeType {
    ...
    /**
     * 
     * 						This enumeration value is no longer applicable as having a PayPal linked to your eBay account is no longer required.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This enumeration value indicates that PayPal has pulled out the 'Collect and Remit' sales tax amount that was originally deposited to the seller's PayPal account. This enumeration value is only applicable if the buyer is based in the US, and their state of residence mandates the collection of sales tax. See the corresponding <b>OrderId</b> value to determine which eBay order this sales tax pertains to.
     * 						<br><br>
     * 						<span class="tablenote"><b>Note: </b>
     * 							As of November 2021, a very large majority of orders go through the eBay payments process, and PayPal is no longer involved in the checkout/payment flow. This enumeration value will soon become deprecated, but this value may still be relevant for older orders. 
     * 						</span>
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This enumeration value indicates that PayPal has deposited the 'Collect and Remit' sales tax amount (for the order identified by the corresponding <b>OrderId</b> field) to the seller's PayPal account. This enumeration value is only applicable if the buyer is based in the US, and their state of residence mandates the collection of sales tax. This sales tax will actually get pulled from the seller's PayPal account shortly after the buyer's funds clear, and the seller should then see a <b>USInternetSalesTax</b> account entry with a matching amount.
     * 						<br><br>
     * 						<span class="tablenote"><b>Note: </b>
     * 							As of November 2021, a very large majority of orders go through the eBay payments process, and PayPal is no longer involved in the checkout/payment flow. This enumeration value will soon become deprecated, but this value may still be relevant for older orders. 
     * 						</span>
    ...
    /**
     * 
     * 						This enumeration value indicates that PayPal has pulled out the 'Goods and Services' tax amount that was originally deposited to the seller's PayPal account. This enumeration value is only applicable to New Zealand sellers for orders that are subject to 'Goods and Services' tax. See the corresponding <b>OrderId</b> value to determine which eBay order this tax pertains to.
     * 						<br><br>
     * 						<span class="tablenote"><b>Note: </b>
     * 							As of November 2021, a very large majority of orders go through the eBay payments process, and PayPal is no longer involved in the checkout/payment flow. This enumeration value will soon become deprecated, but this value may still be relevant for older orders. 
     * 						</span>
    ...
    /**
     * 
     * 						This enumeration value indicates that PayPal has pulled out the 'Goods and Services' tax amount that was originally deposited to the seller's PayPal account. This enumeration value is only applicable to Australian sellers for orders that are subject to 'Goods and Services' tax. See the corresponding <b>OrderId</b> value to determine which eBay order this tax pertains to.
     * 						<br><br>
     * 						<span class="tablenote"><b>Note: </b>
     * 							As of November 2021, a very large majority of orders go through the eBay payments process, and PayPal is no longer involved in the checkout/payment flow. This enumeration value will soon become deprecated, but this value may still be relevant for older orders. 
     * 						</span>
    ...
    /**
     * 
     * 						This enumeration value indicates that PayPal has deposited the 'Goods and Services' tax amount (for the order identified by the corresponding <b>OrderId</b> field) to the seller's account. This enumeration value is only applicable to Australian sellers for orders that are subject to 'Goods and Services' tax. This tax will actually get pulled from the seller's account shortly after the order funds clear, and the seller should then see a <b>AustraliaGST</b> account entry with a matching amount.
     * 						<br><br>
     * 						<span class="tablenote"><b>Note: </b>
     * 							As of November 2021, a very large majority of orders go through the eBay payments process, and PayPal is no longer involved in the checkout/payment flow. This enumeration value will soon become deprecated, but this value may still be relevant for older orders. 
     * 						</span>
    ...
    /**
     * 
     * 						This enumeration value indicates that the account entry is a Deposit Processing Variable fee.
     * 					
     * 
     */
    @XmlEnumValue("DepositProcessingVariableFee")
    DEPOSIT_PROCESSING_VARIABLE_FEE("DepositProcessingVariableFee"),

    /**
     * 
     * 						This enumeration value indicates that the account entry is a credit applied against a Deposit Processing Variable fee.
     * 					
     * 
     */
    @XmlEnumValue("DepositProcessingVariableFeeCredit")
    DEPOSIT_PROCESSING_VARIABLE_FEE_CREDIT("DepositProcessingVariableFeeCredit"),

    /**
     * 
     * 						This enumeration value indicates that the account entry is a Deposit Processing Fixed fee.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This enumeration value indicates that the account entry is a credit applied against a Deposit Processing Fixed fee.
     * 					
     * 
     */
